...
@section('content')
    <div class="container mx-auto w-1/2 mt-5">
        <h1 class="text-2xl font-bold mb-4 text-blue-800">Create Brand</h1>
        {{-- create a form to create a brand using the tailwind css --}}
        <form action="{{ route('brands.store') }}" method="POST" class="bg-white p-4 rounded-md shadow-md">
            @csrf
            <div class="mb-4">
