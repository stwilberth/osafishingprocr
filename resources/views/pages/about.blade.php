                ...
                <div class="order-2 md:order-1">
                    <div class="prose prose-lg">
                        <p class="text-gray-700 leading-relaxed mb-6">
                            Somos una tienda en línea especializada en artículos de pesca, ubicada en la hermosa zona sur de Costa Rica.
                            Fundada por dos amigos apasionados por la pesca, nos dedicamos a ofrecer los mejores equipos y accesorios
                            para pescadores tanto principiantes como experimentados.
                        </p>
                        <p class="text-gray-700 leading-relaxed">
                            Nuestra misión es proporcionar productos de alta calidad y compartir nuestro conocimiento y experiencia
                            con la comunidad de pescadores de la región. Entendemos las necesidades específicas de la pesca en
                            nuestra zona y nos esforzamos por brindar un servicio personalizado a cada uno de nuestros clientes.
                        </p>
                    </div>
                </div>
                <div class="order-1 md:order-2">
                    <img src="{{ asset('images/fishing-about.jpg') }}" alt="Pesca en Costa Rica"
