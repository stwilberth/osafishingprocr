<nav x-data="{ open: false }" class="bg-primary-500 border-b border-primary-400">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center space-x-4">
                @if (Auth::check())
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <x-customize.user_nav :user="Auth::user()" />
                        </x-slot>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-secondary-600 hover:text-secondary-700 hover:bg-primary-100 focus:outline-none focus:bg-primary-100 focus:text-secondary-700 transition duration-150 ease-in-out">
